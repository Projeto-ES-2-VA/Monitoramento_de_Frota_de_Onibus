...
class ParadasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parada" do
    assert_difference("Parada.count") do
      post paradas_url, params: { parada: { bairro: @parada.bairro, cep: @parada.cep, nome: @parada.nome, numero: @parada.numero, rua: @parada.rua } }
    end
  ...
  test "should update parada" do
    patch parada_url(@parada), params: { parada: { bairro: @parada.bairro, cep: @parada.cep, nome: @parada.nome, numero: @parada.numero, rua: @parada.rua } }
